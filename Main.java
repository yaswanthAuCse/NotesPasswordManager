...
public class Main {
    ...
    private static void addNote() {
        ...
        String timestampedNote = "[" + LocalDateTime.now() + "] " + note;
    ...
    private static void viewNotes() {
        if (notes.isEmpty()) {
            ...
            System.out.println("🗒️ Your Notes:");
    ...
    private static void generatePassword() {
        ...
        // Strength indicator
        if (length >= 12 && includeSymbols.equalsIgnoreCase("yes")) {
            System.out.println("💪 Strength: Strong");
        } else if (length >= 8) {
            System.out.println("👍 Strength: Medium");
        } else {
            System.out.println("⚠️ Strength: Weak");
        }
    }
}
